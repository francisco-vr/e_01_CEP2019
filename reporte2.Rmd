...
knitr::kable(tablas[[2]], format = 'latex', booktabs = T, caption = "Tabla cruzada de nivel de acuerdo con pregunta: 'Las políticas públicas generalmente reflejan lo que quiere la mayoría de los ciudadanos', según grado de exposición a información de redes sociales", col.names = c("Muy de acuerdo", "De acuerdo", "NA/ND", "En desacuerdo", "Muy en desacuerdo","NA's", "Total"))
knitr::kable(tablas[[3]], digits = 2, format = "latex", booktabs = T, caption = "varianza y Curtosis sobre preguna 'Las políticas públicas generalmente reflejan lo que quiere la mayoría de los ciudadanos'", col.names = c("Información vía Redes sociales", "Varianza", "Curtosis"))
```
...
knitr::kable(tablas[[6]], digits = 2, format = 'latex', booktabs = T, caption = "Varianza y Curtosis sobre la pregunta 'Los ciudadanos más ricos tienen más influencia que los demás ciudadanos en las políticas públicas'", col.names = c("Información vía Redes sociales", "Varianza", "Curtosis"))
```
...
knitr::kable(tablas[[9]], digits = 2, format = 'latex', booktabs = T, caption = "Varianza y Curtosis sobre el nivel de acuerdo con la pregunta 'Las empresas y los grupos de interés influyen enormemente en las políticas públicas'",col.names = c("Información vía Redes sociales", "Varianza", "Curtosis"))
```

```{r tabP4, echo=FALSE, results='asis'}
knitr::kable(tablas[[10]], digits = 2, format = 'latex', booktabs = T, caption = "descriptivo P4")
knitr::kable(tablas[[11]], digits = 2, format = 'latex', booktabs = T, caption = "tabla cruzada P4", col.names = c("Muy de acuerdo", "De acuerdo", "Ni acuerdo ni desacuerdo", "En desacuerdo", "Muy en desacuerdo","NA's", "Total"))
knitr::kable(tablas[[12]], digits = 2, format = 'latex', booktabs = T, caption = "varianza y kurtosis P4",col.names = c("Información vía Redes sociales", "Varianza", "Curtosis"))
```

```{r tabP5, echo=FALSE, results='asis'}
knitr::kable(tablas[[13]], digits = 2, format = 'latex', booktabs = T, caption = "descriptivo P5")
knitr::kable(tablas[[14]], digits = 2, format = 'latex', booktabs = T, caption = "tabla cruzada P5", col.names = c("Muy de acuerdo", "De acuerdo", "Ni acuerdo ni desacuerdo", "En desacuerdo", "Muy en desacuerdo","NA's", "Total"))
knitr::kable(tablas[[15]], digits = 2, format = 'latex', booktabs = T, caption = "varianza y kurtosis P5", col.names = c("Información vía Redes sociales", "Varianza", "Curtosis"))
```
