...
Las siguientes cosas son importantes:

- Las RRSS aumentan la toma de posición en la política; podría hablarde de una mayr eficiencia en la información incluso -> cominucación intepersonal, confianza y homofilia política

- De todas formas llaman a un pensamiento más extremo que el de otras formas de informarse. acá podríamos hablar que más que polarización de la población, podemos hablar que el hallazgo principal es que las RRSS inducen a un pensamiento algo más extremo.
  -> Este extremismo no es contra cualquier cosa; acá lo hemos constatado sobre todo para cuestones relativas a quienes ejercen poder sobre el estado y las decisciones políticas es donde más asociación hay entre pensamiento extremo y consumo de redes sociales. 
  -> No así con el rol de los partidos políticos. si bien la tendencia permanece el pensamiento extremo se desvanece y hay también incluso na mejor valoración a los partidos políticos que quienes reciben poca información. (acá poder tirarme un rollo más bien de la desafección política metizada, de que no es con todas las cosas y quizás las persoans suelen distinguir entre algunos partidos y otros)

-> Deficiencias de la investigación: Falta análisis de test estadísticos, y pdobar con variables de control como nivel educativo o nivel socioeconómico.

-> Nuevas vías de investigación: aprovechar la larga data de la CEP y empezar a realizar un estudio de año a año según la politización de la información, que hasta donde sé desde el 2013 en adelante comienza a preguntar por el tipo de información que uno ve. hacer un trabajo comparativo entre quienes venmucha información de redes sociales vesus otros medios de comunicación como televisión, Radio o Diarios en papel, el cual puede ayudar a ver más variantes.
...
```{r, tablaaneza1, results='asis', echo=FALSE}
