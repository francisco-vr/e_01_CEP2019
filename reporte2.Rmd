...
**This is an R Markdown document**. Markdown is a simple formatting syntax for authoring _HTML, PDF, and MS Word_¨ documents. For more details on using R Markdown see <http://rmarkdown.rstudio.com>.

* puede que quede sola
...
Sin embargo para este grico sí funciona, aunque bastante feo.
