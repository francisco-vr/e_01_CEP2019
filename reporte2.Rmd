...
knitr::kable(tablas[[1]], digits = 2, format = 'latex', booktabs = T, caption = "descriptivo P1")
knitr::kable(tablas[[2]], digits = 2, format = 'latex', booktabs = T, caption = "Tabla cruzada P1", col.names = c("Muy de acuerdo", "De acuerdo", "Ni acuerdo ni desacuerdo", "En desacuerdo", "Muy en desacuerdo","NA's", "Total"))
knitr::kable(tablas[[3]], digits = 2, format = "latex", booktabs = T, caption = "variana y kurtosis P1", col.names = c("Información vía Redes sociales", "Varianza", "Curtosis"))
```
